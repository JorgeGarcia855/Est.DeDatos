...
//        g.agregarRuta('d','f', 4);
//        g.agregarRuta('e','f', 4);
        g.agregarRuta('t','d', 100);
        g.agregarRuta('t','c', 150);
        g.agregarRuta('t','p', 350);
        g.agregarRuta('t','x', 340);
        g.agregarRuta('d','c', 90);
        g.agregarRuta('c','p', 100);
        g.agregarRuta('p','x', 20);
        char inicio = 'x';
        char fin    = 'd';
