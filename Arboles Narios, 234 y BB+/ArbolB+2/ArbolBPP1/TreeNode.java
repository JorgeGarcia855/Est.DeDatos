...
public class TreeNode {
   ...
   Creates a leafNode with empty list of key value pairs and child nodes
    ...
    protected void deletePairNode(int key, ArbolBPP1.BplusTree tree) {
     ...
     */
    public List<Double> searchRange(int key1, int key2, ArbolBPP1.BplusTree tree) {
        List<Pair<Integer, Double>> p2 = getAllPairs(tree);

        List<Double> searchList = new ArrayList<Double>();
        for (Pair<Integer, Double> integerDoublePair : p2) {
            if (integerDoublePair.getKey() >= key1 && integerDoublePair.getKey() <= key2) {
                searchList.add(integerDoublePair.getValue());
            }
        }
        return searchList;
    }
     ...
     */
    public List<Pair<Integer, Double>> deleteFromNode(int key, ArbolBPP1.BplusTree tree) {
     ...
     */
    public String search(int key, ArbolBPP1.BplusTree tree) {
    ...
    public List<Pair<Integer, Double>> getAllPairs(ArbolBPP1.BplusTree tree) {
    ...
    public void insertOrModify(int key, Double value, ArbolBPP1.BplusTree tree) {
        /*
        Case 1 - Leaf node
         */
        if (isLeaf) {
    ...
    public List<Pair<Integer, Double>> updateInNode(int key, ArbolBPP1.BplusTree tree) {
        List<Pair<Integer, Double>> newPair = getAllPairs(tree);
    ...
    private void spiltTheNode(int key, Double value, TreeNode left,
                              TreeNode right, ArbolBPP1.BplusTree tree) {
        // key size left node
    ...
    public void updatePairsNode(List<Pair<Integer, Double>> pairSet, ArbolBPP1.BplusTree tree) {
     ...
     */
    protected void modifyInsert(ArbolBPP1.BplusTree tree) {
    ...
    protected void binary_search(int left, int right, int key, Double value, ArbolBPP1.BplusTree tree) {
